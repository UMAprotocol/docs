...
<!-- - [Approved mainnet collateral currencies](https://docs.umaproject.org/developers/mainnet-info#approved-collateral-types-and-final-fees)
- [Approved mainnet price identifiers](https://docs.umaproject.org/developers/mainnet-info#approved-identifiers) -->
